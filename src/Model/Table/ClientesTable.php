...
class ClientesTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setDisplayField('razon_social_cliente');
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('rut_cliente')
            ->maxLength('rut_cliente', 12)
            ->requirePresence('rut_cliente', 'create')
            ->notEmptyString('rut_cliente');

        $validator
            ->scalar('razon_social_cliente')
            ->maxLength('razon_social_cliente', 200)
            ->allowEmptyString('razon_social_cliente');

        $validator
            ->scalar('giro_cliente')
            ->maxLength('giro_cliente', 500)
            ->allowEmptyString('giro_cliente');

        $validator
            ->scalar('correo_cliente')
            ->maxLength('correo_cliente', 50)
            ->requirePresence('correo_cliente', 'create')
            ->notEmptyString('correo_cliente');
