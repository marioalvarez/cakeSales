...
class ProductosTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->maxLength('nombre_producto', 50)
            ->allowEmptyString('nombre_producto');

        $validator
            ->integer('precio_unitario_producto')
            ->allowEmptyString('precio_unitario_producto');

        $validator
            ->integer('costo_producto')
            ->allowEmptyString('costo_producto');
